        ...
        <div className="bg-white h-[80px] w-full flex items-center border-b-2 border-gray-200">
            ...
            <div className="hidden sm:flex flex-row items-center justify-between w-full ml-auto">
                <div className="flex flex-row gap-4 ml-12">
                    <Link to="/veterinarian/sick-animals">
                        <p className="text-xl p-[23px] text-gray-800 hover:border-[#F4E7CB] border-b-4 border-white hover:border-b-4 transition-all duration-200">Wykaz chorych zwierząt</p>
                    </Link>
                    <Link to="/veterinarian/register-treatment">
                        <p className="text-xl p-[23px] text-gray-800 hover:border-[#F4E7CB] border-b-4 border-white hover:border-b-4 transition-all duration-200">Rejestruj leczenie</p>
                    </Link>
                    <Link to="/veterinarian/account">
                        <p className="text-xl p-[23px] text-gray-800 hover:border-[#F4E7CB] border-b-4 border-white hover:border-b-4 transition-all duration-200">Konto</p>
                    </Link>
                </div>
            ...
            <div className={`fixed sm:hidden top-0 w-[60%] h-full bg-white z-50 ease-in-out duration-300 transition-all ${menu ? 'left-0' : 'left-[-100%]'}`}>
                <ul className="pt-4 mx-4">
                    <Link to="/veterinarian/sick-animals">
                        <li className="p-3 border-b-2 border-gray-200 hover:border-[#F4E7CB] duration-200">Wykaz chorych zwierząt</li>
                    </Link>
                    <Link to="/veterinarian/register-treatment">
                        <li className="p-3 border-b-2 border-gray-200 hover:border-[#F4E7CB] duration-200">Rejestruj leczenie</li>
                    </Link>
                    <Link to="/veterinarian/account">
                        <li className="p-3 border-b-2 border-gray-200 hover:border-[#F4E7CB] duration-200">Konto</li>
                    </Link>
                </ul>
