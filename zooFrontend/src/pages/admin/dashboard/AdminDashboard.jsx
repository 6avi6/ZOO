  ...
  return (
      ...
      <div className="w-full h-screen flex flex-col items-center justify-center">
          ...
          <div className="flex flex-row w-full gap-4 justify-center text-center m-8 ">
              <div className="flex flex-col items-center w-1/3 min-w-72 p-5 border border-gray-300 bg-white shadow-md h-72 rounded-lg hover:border-[#2c5282] hover:scale-[1.03] transition-all duration-300 cursor-pointer"
